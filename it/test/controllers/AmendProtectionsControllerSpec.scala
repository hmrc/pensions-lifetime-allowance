...
class AmendProtectionsControllerSpec extends IntegrationSpec {
  ...
  def fakeRequest(body: JsValue): FakeRequest[JsValue] =
    FakeRequest(method = "PUT", uri = "", headers = FakeHeaders(Seq("content-type" -> "application.json")), body = body)

  def validAmendIPBody(ninoWithoutSuffix: String, protectionType: String): JsObject =
    Json
      .parse(s"""
                |  {
  ...
  def validAmendSubmissionIPBody(ninoWithoutSuffix: String, protectionType: Int) =
    Json
      .parse(s"""
                |{
                |  "nino" : "$ninoWithoutSuffix",
  ...
  def sucessfulAuditResult(nino: String, ninoWithoutSuffix: String, protectionId: Long, protectionType: Int): String =
    Json
      .parse(
        s"""
           |{
  ...
  "AmendProtectionsController" when {
    ...
    "amending an IP2016 application" in {
      ...
      def result: WSResponse =
        client(s"individuals/$nino/protections/$id").put(validAmendIPBody(ninoWithoutSuffix, "IP2016")).futureValue
      ...
      "submit the correct json to nps" in {
        ...
        result
        verify(
          putRequestedFor(urlEqualTo(s"/pensions-lifetime-allowance/individual/$ninoWithoutSuffix/protections/$id"))
      ...
      "submit the correct auditing data" in {
        ...
        verify(
          postRequestedFor(urlEqualTo("/write/audit/merged"))
            .withRequestBody(
              equalToJson(
                failureAuditResponse(nino, ninoWithoutSuffix, 3, SERVICE_UNAVAILABLE, "error message", 1),
                false,
                true
              )
            )
      ...
      "submit the correct auditing data" in {
        ...
        verify(
          postRequestedFor(urlEqualTo("/write/audit/merged"))
            .withRequestBody(
              equalToJson(
                failureAuditResponse(nino, ninoWithoutSuffix, 3, BAD_GATEWAY, "error message", 1),
                false,
                true
              )
            )
      ...
      "submit the correct auditing data" in {
        ...
        verify(
          postRequestedFor(urlEqualTo("/write/audit/merged"))
            .withRequestBody(
              equalToJson(
                failureAuditResponse(nino, ninoWithoutSuffix, 3, UNAUTHORIZED, "error message", 1),
                false,
                true
              )
            )
    ...
    "submitting an amend IP2016 application which results in a generic 400 response" in {
      ...
      "submit the correct auditing data" in {
        ...
        verify(
          postRequestedFor(urlEqualTo("/write/audit/merged"))
            .withRequestBody(
              equalToJson(failureAuditResponse(nino, ninoWithoutSuffix, 3, FORBIDDEN, "error message", 1), false, true)
            )
        )
      }
    }
      ...
      "submit the correct auditing data" in {
        ...
        verify(
          postRequestedFor(urlEqualTo("/write/audit/merged"))
            .withRequestBody(
              equalToJson(
                failureAuditResponse(nino, ninoWithoutSuffix, 3, BAD_REQUEST, "error message", 1),
                false,
                true
              )
            )
    ...
    "amending an IP2014 application" in {
      ...
      def result: WSResponse =
        client(s"individuals/$nino/protections/$id").put(validAmendIPBody(ninoWithoutSuffix, "IP2014")).futureValue
      ...
      "submit the correct auditing data" in {
        ...
        verify(
          postRequestedFor(urlEqualTo("/write/audit/merged"))
            .withRequestBody(
              equalToJson(
                failureAuditResponse(nino, ninoWithoutSuffix, 2, SERVICE_UNAVAILABLE, "error message", 1),
                false,
                true
              )
            )
      ...
      "submit the correct auditing data" in {
        ...
        verify(
          postRequestedFor(urlEqualTo("/write/audit/merged"))
            .withRequestBody(
              equalToJson(
                failureAuditResponse(nino, ninoWithoutSuffix, 2, BAD_GATEWAY, "error message", 1),
                false,
                true
              )
            )
      ...
      "submit the correct auditing data" in {
        ...
        verify(
          postRequestedFor(urlEqualTo("/write/audit/merged"))
            .withRequestBody(
              equalToJson(
                failureAuditResponse(nino, ninoWithoutSuffix, 2, UNAUTHORIZED, "error message", 1),
                false,
                true
              )
            )
    ...
    "submitting an amend IP2014 application which results in a generic 400 response" in {
      ...
      "submit the correct auditing data" in {
        ...
        verify(
          postRequestedFor(urlEqualTo("/write/audit/merged"))
            .withRequestBody(
              equalToJson(failureAuditResponse(nino, ninoWithoutSuffix, 2, FORBIDDEN, "error message", 1), false, true)
            )
        )
      }
    }
      ...
      "submit the correct auditing data" in {
        ...
        verify(
          postRequestedFor(urlEqualTo("/write/audit/merged"))
            .withRequestBody(
              equalToJson(
                failureAuditResponse(nino, ninoWithoutSuffix, 2, BAD_REQUEST, "error message", 1),
                false,
                true
              )
            )
